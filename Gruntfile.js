...
module.exports = function (grunt) {
	...
	grunt.initConfig({
		...
		usemin: {
			html: ['<%= yeoman.dist %>/public/index.html', '<%= yeoman.dist %>/public/views/{,*/}*.html'],
				...
				files: [
					{
						expand: true,
						cwd: '<%= yeoman.app %>',
						src: ['index.html', 'views/*.html', 'partials/**/*.html'],
						dest: '<%= yeoman.dist %>/public'
					}
				]
			}
		...
		manifest: {
			generate: {
				...
				dest: "<%= yeoman.dist %>/public/on.appcache"
			}
		},
