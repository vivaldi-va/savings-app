...
exports.getTimeline = function(req, res, next) {
	...
	finances.intFinances(req.signedCookies.saIdent, next)
		.then(function(success) {
			res.send(200, _calcMonthBalance(_createTimelineData(success)));
		});
};
