			...
			if(user) {
				...
				Recover.create({
					...
					var transporterOptions = {
						...
						html: "Hello, \n\r" +
							"looks like you have requested to reset your account password. " +
							"Please follow this link to recover your account:\r\n" +
							"<a href=\"" + "http://ec2-54-72-241-251.eu-west-1.compute.amazonaws.com/" + "/app/#/recover/" + token + "\"></a>"
					};
